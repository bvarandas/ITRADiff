...
namespace GI.Integracao.SecureClient.Domain.Models.TRA
{
    public class ITRABase
    {
        ...
        public class Body
        {
            public string TipoRegistro { get { return "01"; } } // 2
            ...
            public string Reserva { get; set; } // 20
        }
        ...
        public class Trailer
        {
            ...
            public string CodigoDestino { get; set; } //4
            public string DataGeracaoArquivo { get; set; } //8 - AAAAMMDD
            public string TotalRegistros { get; set; } //9 - total de registros incluindo header and trailer
